...
const es: Language = {
    ...
    header: {
        links: [
            ...
            { href: "#culture", label: "Nuestra Cultura" },
    ...
    experienceBanner: {
        ...
        description:
            "Nuestro compromiso, trayectoria y red global nos permite ofrecer soluciones confiables, ágiles y personalizadas.",
    ...
    cta: {
        title: "¿Necesitas importar o exportar mercadería?",
        description:
            "Te acompañamos en cada paso para que tu operación sea simple, segura y eficiente.",
